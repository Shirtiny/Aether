...
| Platform | Download |
|----------|----------|
| Linux x86_64 (GNU) | [aether-tunnel-linux-amd64.tar.gz](https://github.com/Shirtiny/Aether/releases/download/tunnel-v0.3.16/aether-tunnel-linux-amd64.tar.gz) |
| Linux ARM64 (GNU) | [aether-tunnel-linux-arm64.tar.gz](https://github.com/Shirtiny/Aether/releases/download/tunnel-v0.3.16/aether-tunnel-linux-arm64.tar.gz) |
| Linux x86_64 (musl) | [aether-tunnel-linux-musl-amd64.tar.gz](https://github.com/Shirtiny/Aether/releases/download/tunnel-v0.3.16/aether-tunnel-linux-musl-amd64.tar.gz) |
| Linux ARM64 (musl) | [aether-tunnel-linux-musl-arm64.tar.gz](https://github.com/Shirtiny/Aether/releases/download/tunnel-v0.3.16/aether-tunnel-linux-musl-arm64.tar.gz) |
| macOS x86_64 | [aether-tunnel-macos-amd64.tar.gz](https://github.com/Shirtiny/Aether/releases/download/tunnel-v0.3.16/aether-tunnel-macos-amd64.tar.gz) |
| macOS ARM64 | [aether-tunnel-macos-arm64.tar.gz](https://github.com/Shirtiny/Aether/releases/download/tunnel-v0.3.16/aether-tunnel-macos-arm64.tar.gz) |
| Windows x86_64 | [aether-tunnel-windows-amd64.zip](https://github.com/Shirtiny/Aether/releases/download/tunnel-v0.3.16/aether-tunnel-windows-amd64.zip) |
<!-- DOWNLOAD_TABLE_END -->
...
```bash
curl -fsSL https://raw.githubusercontent.com/Shirtiny/Aether/custom/apps/aether-tunnel/install.sh | sh
```

Windows PowerShell:

```powershell
irm https://raw.githubusercontent.com/Shirtiny/Aether/custom/apps/aether-tunnel/install.ps1 | iex
```

也可以用环境变量非交互式执行，适合在控制台“添加隧道节点”时生成命令：

```bash
curl -fsSL https://raw.githubusercontent.com/Shirtiny/Aether/custom/apps/aether-tunnel/install.sh | \
