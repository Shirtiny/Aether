...
const RERANK_ROUTE_TEST_STACK_BYTES: usize = 32 * 1024 * 1024;

fn run_rerank_route_test<F, Fut>(test_name: &'static str, make_future: F)
where
    ...
    Fut: std::future::Future<Output = ()> + 'static,
{
    let handle = std::thread::Builder::new()
        ...
        .stack_size(RERANK_ROUTE_TEST_STACK_BYTES)
        .spawn(move || {
        ...
        .expect("rerank route test thread should spawn");
