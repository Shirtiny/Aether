...
```bash
# 1. 克隆代码
git clone https://github.com/Shirtiny/Aether.git
cd Aether
...
```bash
cd Aether && cd Aether
curl -fsSL https://raw.githubusercontent.com/Shirtiny/Aether/custom/install.sh | sudo bash
```
...
[![Star History Chart](https://api.star-history.com/svg?repos=Shirtiny/Aether&type=Date)](https://star-history.com/#Shirtiny/Aether&Date)
