...
pub struct WebSocketConfig {
    ...
    /// Maximum capacity retained by the write buffer after all queued bytes have been written.
    /// Once a successful write fully drains the buffer, capacities above this value are reduced
    /// towards [`write_buffer_size`](Self::write_buffer_size). Partial and failed writes retain the
    /// allocation until their queued bytes are delivered.
    ///
    /// The default is unlimited, preserving upstream tungstenite behavior.
    pub max_retained_write_buffer_capacity: usize,
...
impl Default for WebSocketConfig {
    fn default() -> Self {
        Self {
            ...
            max_retained_write_buffer_capacity: usize::MAX,
...
impl WebSocketConfig {
    ...
    /// Set [`Self::max_retained_write_buffer_capacity`].
    pub fn max_retained_write_buffer_capacity(
        mut self,
        max_retained_write_buffer_capacity: usize,
    ) -> Self {
        self.max_retained_write_buffer_capacity = max_retained_write_buffer_capacity;
        self
    }
...
impl WebSocketContext {
    ...
    fn _new(role: Role, mut frame: FrameCodec, config: WebSocketConfig) -> Self {
        ...
        frame.set_max_retained_out_buffer_capacity(config.max_retained_write_buffer_capacity);
        Self {
            role,
            frame,
    ...
    pub fn set_config(&mut self, set_func: impl FnOnce(&mut WebSocketConfig)) {
        ...
        self.frame
            .set_max_retained_out_buffer_capacity(self.config.max_retained_write_buffer_capacity);
    }
