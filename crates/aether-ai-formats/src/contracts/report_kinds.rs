...
pub const OPENAI_SEARCH_SYNC_FINALIZE_REPORT_KIND: &str = "openai_search_sync_finalize";
...
pub const OPENAI_SEARCH_SYNC_ERROR_REPORT_KIND: &str = "openai_search_sync_error";
...
pub fn implicit_sync_finalize_report_kind(plan_kind: &str) -> Option<&'static str> {
    match plan_kind {
        ...
        OPENAI_SEARCH_SYNC_PLAN_KIND => Some(OPENAI_SEARCH_SYNC_FINALIZE_REPORT_KIND),
...
pub fn core_error_default_client_api_format(report_kind: &str) -> Option<&'static str> {
    match report_kind {
        ...
        OPENAI_SEARCH_SYNC_FINALIZE_REPORT_KIND => Some("openai:search"),
...
pub fn core_error_background_report_kind(report_kind: &str) -> Option<&'static str> {
    match report_kind {
        ...
        OPENAI_SEARCH_SYNC_FINALIZE_REPORT_KIND => Some(OPENAI_SEARCH_SYNC_ERROR_REPORT_KIND),
...
pub fn core_success_background_report_kind(report_kind: &str) -> Option<&'static str> {
    match report_kind {
        ...
        OPENAI_SEARCH_SYNC_FINALIZE_REPORT_KIND => Some(OPENAI_SEARCH_SYNC_SUCCESS_REPORT_KIND),
