...
const ADMIN_API_FORMAT_DEFINITIONS: &[AdminApiFormatDefinition] = &[
    ...
    AdminApiFormatDefinition {
        ...
        aliases: &["openai_search", "alpha_search"],
    },
    AdminApiFormatDefinition {
    ...
    fn build_admin_system_check_update_payload_reports_available_release() {
        let payload = build_admin_system_check_update_payload_with_release(
            ...
            Some(AdminSystemUpdateRelease {
                ...
                release_url: Some(
                    "https://github.com/Shirtiny/Aether/releases/tag/v0.7.0-rc28".to_string(),
                ),
        ...
        assert_eq!(
            payload["release_url"],
            "https://github.com/Shirtiny/Aether/releases/tag/v0.7.0-rc28"
        );
    ...
    fn build_admin_system_check_update_payload_reports_updatable_release() {
        let payload = build_admin_system_check_update_payload_with_release(
            ...
            Some(AdminSystemUpdateRelease {
                ...
                release_notes: None,
                published_at: None,
                tarball_url: Some("https://github.com/Shirtiny/Aether/releases/download/v0.7.0-rc28/aether.tar.gz".to_string()),
                sha256sums_url: Some("https://github.com/Shirtiny/Aether/releases/download/v0.7.0-rc28/SHA256SUMS".to_string()),
            }),
            None,
        );
